...
{
    public class SubscriptionPaymentRepository : RepositoryBase<Payment>, ISubscriptionPaymentRepository
    {
        ...
        public async Task<List<CoProducerDebts>> GetAllCoproducersDebts()
        {
            ...
            return new List<CoProducerDebts>();
        }
        ...
        public async Task<List<ProducerPendingPayments>> GetAllProducerPendingPayments()
        {
            ...
            return new List<ProducerPendingPayments>();
        }
